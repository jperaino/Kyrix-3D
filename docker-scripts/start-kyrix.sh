...
SRCDATA_PROJECT_NAME=${SRCDATA_PROJECT_NAME:-dots_deep_uniform}
SRCDATA_DB=${SRCDATA_DB:-dots_deep_uniform}
SRCDATA_DB_TEST_TABLE=${SRCDATA_DB_TEST_TABLE:-dots_deep_uniform}  # source table (one of...) checked to avoid duplicate loads
...
SRCDATA_DB_LOAD_CMD=${SRCDATA_DB_LOAD_CMD:-/kyrix/compiler/examples/dots-deep-uniform/reload-dots-uniform.sh}
KYRIX_DB_INDEX_CMD=${KYRIX_DB_INDEX_CMD:-/kyrix/compiler/examples/dots-deep-uniform/reindex-dots-uniform.sh}
