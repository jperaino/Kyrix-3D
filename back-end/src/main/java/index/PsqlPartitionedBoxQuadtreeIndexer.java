...
public class PsqlPartitionedBoxQuadtreeIndexer extends BoundingBoxIndexer {

    private static PsqlPartitionedBoxQuadtreeIndexer instance = null;
    private static final int NUM_PARTITIONS = 10;

    private PsqlPartitionedBoxQuadtreeIndexer() {}

    public static synchronized PsqlPartitionedBoxQuadtreeIndexer getInstance() {
        if (instance == null) instance = new PsqlPartitionedBoxQuadtreeIndexer();
        return instance;
    }
    ...
    public ArrayList<ArrayList<String>> getDataFromRegion(
        ...
        System.out.println("in psql partitioned box quadtree spatial indexer");
